...
SELECT 
    month_no,
    month,
    IFNULL(AVG(CASE WHEN year = '2016' THEN real_delivery_time END), NULL) AS Year2016_real_time,
    IFNULL(AVG(CASE WHEN year = '2017' THEN real_delivery_time END), NULL) AS Year2017_real_time,
    IFNULL(AVG(CASE WHEN year = '2018' THEN real_delivery_time END), NULL) AS Year2018_real_time,
    IFNULL(AVG(CASE WHEN year = '2016' THEN estimated_delivery_time END), NULL) AS Year2016_estimated_time,
    IFNULL(AVG(CASE WHEN year = '2017' THEN estimated_delivery_time END), NULL) AS Year2017_estimated_time,
    IFNULL(AVG(CASE WHEN year = '2018' THEN estimated_delivery_time END), NULL) AS Year2018_estimated_time
FROM delivery_times
